/* Programa JS responsável por gerenciar a exibição das palavras e permitir a 
exclusão de algumas delas
 */
...
function montarTabela() {
    ...
    if (localStorage.getItem("jogoPalavra")) {
        ...
        var linha, col1, col2, col3; // declara variáveis
        ...
        for (var i = 0; i < palavras.length; i++) {
            ...
            col3.innerHTML = "<input type='checkbox'> "; //exibe campo checkbo
        }
    }
}
...
function removePalavras() {
    ...
    if (confirm("Confirma Exclusão das Palavras Selecionadas?")) {
        ...
        // se vazio, significa que marcou todos os checkbox (não salva em localStorage)
        if (palavras != "") {
